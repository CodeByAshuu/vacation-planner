  ...
  return (
    <div className="text-center py-20 max-w-4xl mx-auto">
      ...
      <div className="flex justify-center gap-6 mb-10">
        <img src="/img1.jpg" className="w-19 lg:w-50 rounded-xl rotate-[-6deg]" />
        <img src="/img2.jpg" className="w-24 lg:w-54 rounded-xl scale-110 shadow-lg" />
        <img src="/img3.avif" className="w-19 lg:w-50 rounded-xl rotate-6" />
      </div>
